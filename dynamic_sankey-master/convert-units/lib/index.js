var convert
  ...
  , measures = {
    ...
    , thermalConductivity: require('./definitions/thermalConductivity')
    ...
    , hourlyHeatCapacity: require('./definitions/hourlyHeatCapacity')
    , angle : require('./definitions/angle')
    , volumetricHeat : require('./definitions/volumetricHeat')
    , volumetricEnergy : require('./definitions/volumetricEnergy')
    , specificVolume : require('./definitions/specificVolume')
    }
  , Converter;
